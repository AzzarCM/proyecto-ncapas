...
(
    ...
    contrasenia character varying(60) COLLATE pg_catalog."default",
    id_municipio integer,
    id_rol integer,
...
VALUES (10, 'admin', 'Prueba', '2000-09-03', 2020, 'Pinares De Suiza', true, 'admon', '$2a$04$8Fw39Lis0MO02Tx/KjUAduuEeaGTz1tMOBRUI2FwTep9MUYyWnUeK', 80 ,1);


-- Usuario coordinador de prueba (ya esta activado)
-- username: coor ; contrasenia : admin
INSERT INTO usuario(id_usuario, nombre, apellido, fecha_nacimiento, edad, direccion, estado, nombre_usuario, contrasenia, id_municipio, id_rol) 
VALUES (11, 'coordinador', 'Prueba', '2000-09-03', 20, 'Pinares De Suiza', true, 'coor', '$2a$04$8Fw39Lis0MO02Tx/KjUAduuEeaGTz1tMOBRUI2FwTep9MUYyWnUeK', 80 ,2);


-- Materias
INSERT INTO catalogo_materias(id_catmateria, nombre, estado) VALUES (3312, 'Programacion N-capas', true);
INSERT INTO catalogo_materias(id_catmateria, nombre, estado) VALUES (2228, 'Tecnicas de simulacion en computadora', true);
INSERT INTO catalogo_materias(id_catmateria, nombre, estado) VALUES (7862, 'Fundamentos de inteligencia de negocios', true);
INSERT INTO catalogo_materias(id_catmateria, nombre, estado) VALUES (4340, 'Arquitectura de computadoras', true);
INSERT INTO catalogo_materias(id_catmateria, nombre, estado) VALUES (2020, 'Matematica 2', false);

-- Instituciones
INSERT INTO catalogo_ce(id_catce, nombre, estado, id_municipio) VALUES(4444, 'Centro Escolar OEI', true, 80);
INSERT INTO catalogo_ce(id_catce, nombre, estado, id_municipio) VALUES(5555, 'Centro Escolar Quezaltepec', true, 80);
INSERT INTO catalogo_ce(id_catce, nombre, estado, id_municipio) VALUES(4433, 'Colegio Nazareth', true, 80);
INSERT INTO catalogo_ce(id_catce, nombre, estado, id_municipio) VALUES(5533, 'Colegio Fatima', true, 80);
INSERT INTO catalogo_ce(id_catce, nombre, estado, id_municipio) VALUES(4455, 'Colegio Belen', true, 80);
INSERT INTO catalogo_ce(id_catce, nombre, estado, id_municipio) VALUES(2230, 'Colegio champagnat', true, 80);
INSERT INTO catalogo_ce(id_catce, nombre, estado, id_municipio) VALUES(3031, 'La sagrada familia', true, 163);

-- Estudiante
INSERT INTO expediente(id_estudiante, nombres, apellidos, carne_min, fecha_nacimiento, edad, direccion, tel_fijo, tel_movil, nombre_padre, nombre_madre,id_catce)
VALUES(100, 'Danniela', 'Renderos', '0584510-5', '1998-12-13', 21, 'aqui va la direccion jaja', '2222-7777', '7678-3896', 'papa de ale', 'mama de ale',3031);

-- Materia
INSERT INTO materia(id_materia, id_catmateria, anio, ciclo, nota, id_estudiante, resultado)
VALUES(50, 3312, 2020, 1, 10, 100, 'APROBADO');